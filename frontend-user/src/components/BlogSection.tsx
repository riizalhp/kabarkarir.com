  ...
  return (
    <div className="bg-white rounded-lg shadow overflow-hidden transition duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col">
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <h3 onClick={() => onSelectArticle(post.id)} className="font-semibold text-secondary mt-3 h-12 text-ellipsis overflow-hidden cursor-pointer hover:text-primary transition-colors">{post.title}</h3>
