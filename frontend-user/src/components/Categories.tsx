    ...
    <section className="py-10 px-4 bg-gray-50">
      <div className="container mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-secondary">Kategori Lowongan</h2>
          <p className="text-gray-600 mt-2">Pilih kategori yang sesuai dengan minat dan keahlianmu</p>
        </div>
